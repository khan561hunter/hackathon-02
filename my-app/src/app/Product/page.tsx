...
import line2 from "@/app/assets/Line 4.png"
...
export default function Men(){
    return(
        <main className="relative lg:max-w-[1440px] md:max-w-[1440px] w-full m-auto absolute top-[100px]">
            <div className="" >
                <div className="flex gap-x-2 text-[#00000099] absolute left-[100px]">
                    <Link className="hover:text-black" href="/">Home </Link>
                    <div>{`>`}</div>
                    <Link className="hover:text-black"  href="/Product">Shop {`>`} Men {`>`} Tshirts</Link>
                </div>

                <div className="absolute top-[134px] left-[100px]">
                    <Image src={line2} alt="line2"></Image>
                </div>    

                <div className="absolute top-[216px] left-[100px] flex gap-x-3">
                    <div className="grid gap-y-3">
                        <Image src={tshirt1} alt="tsh1"></Image>
                        <Image src={tsh3} alt="tsh2"></Image>
                        <Image src={tsh4} alt="tsh3"></Image>
                    </div>
                    <Image src={tsh2} alt="tsh4"></Image>
