...
export default function One(){
    return(
        <div className=" flex items-center relative">
            <Image className="w-[1440px]  h-[663px]   absolute top-[134px]" src={rec} alt="rect"></Image>
            <Image className=" absolute  top-[431px]  left-[750px]" src={vector} alt="vector"></Image>
            <Image className=" absolute  top-[220px]  left-[1200px]" src={vector2} alt="vector"></Image>
            
            
            
            <Image className="  w-[577px]  h-[173px]   absolute  top-[237px]  left-[100px] " src={find} alt="find"></Image>
            <div className=" w-[545px]   h-[33px]  absolute top-[442px] left-[100px]"><p className="font-normal  text-[16px] leading-[22px] text-[#00000099]  ">Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.</p></div>
            <div className="w-[210px] h-[52px]  bg-[black] rounded-[62px]    absolute top-[507px] left-[100px] my-[12px] ">
                <p className="w-[75px] h-[22px] text-white font-medium text-[16px] leading-[21.6px] text-nowrap px-[65px] py-[16px] ">Shop Now</p>
            </div>
            <div>
                
            </div>
            <div className=" w-[596px] h-[74px] absolute top-[607px] left-[100px] flex items-center ">
                ...
                <div className="w-[171px] h-[74px] mx-[90px] my-[-50px]">
